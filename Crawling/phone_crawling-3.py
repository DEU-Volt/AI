...
# 제목 : 세티즌 중고상품 휴대폰 범주 한정 (제목, 가격) 크롤링 소스
# 작성자 : 전규빈
...
with webdriver.Edge('msedgedriver.exe') as driver:
    ...
    while True:
        try:
            driver.get(f"https://market.cetizen.com/market.php?auc_sale=1&auc_wireless=5&cat[0]=3&p={page_number}")
        except Exception as e:
            print(e)
            break

        title_locator = (By.CSS_SELECTOR, "div > div.ln18 > div:nth-child(2) > span > a > span")
        price_locator = (By.CSS_SELECTOR, "div > div:nth-child(3) > span.pt14.b")
